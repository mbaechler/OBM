...
public class EventRecurrence {
	...
	public boolean hasImportantChanges(EventRecurrence recurrence) {
		...
		Set<Event> events = Sets.symmetricDifference(this.getEventExceptions(), recurrence.getEventExceptions(), 
				new ComparatorUsingEventDate(), new ComparatorUsingEventHasImportantChanges());

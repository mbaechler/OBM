...
--
-- @version $Id: create_engine.ddl,v 1.1 2008-07-01 21:54:11 nichele Exp $
--
...
create table fnbl_pending_notification (
  ...
  constraint fk_pn_username foreign key (username)
  references fnbl_user (username) on delete cascade on update cascade,
  constraint fk_pn_device foreign key (device)
  references fnbl_device (id) on delete cascade on update cascade
);
...
INSERT INTO fnbl_sync_source VALUES ('card','obm/obm/obm-contact/obm_book_vcard.xml','card','obm-contact'),('event','obm/obm/obm-calendar/obm_cal_ical.xml','event','obm-calendar');

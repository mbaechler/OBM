...
@Singleton
public class Ical4jHelperImpl implements Ical4jHelper {
	...
	private static Logger logger = LoggerFactory.getLogger(Ical4jHelperImpl.class);
	...
	@Inject
	@VisibleForTesting
	public Ical4jHelperImpl(DateProvider obmHelper, EventExtId.Factory eventExtIdFactory, AttendeeService attendeeService) {

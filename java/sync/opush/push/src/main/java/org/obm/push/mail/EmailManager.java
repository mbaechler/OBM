...
public class EmailManager implements IEmailManager {
	...
	public void markEmailsAsSynced(Integer devId, Integer collectionId, Date lastSync, Collection<Email> emails) throws DaoException {
		...
		Set<Email> emailsNeverTrackedBefore = filterAlreadySyncedEmails(allEmailsToMark, alreadySyncedEmails);
	...
	private Set<Email> filterAlreadySyncedEmails(Set<Email> allEmailsToMark, Set<Email> alreadySyncedEmails) {

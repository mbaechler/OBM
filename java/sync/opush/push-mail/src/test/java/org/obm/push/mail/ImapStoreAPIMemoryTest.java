...
public class ImapStoreAPIMemoryTest {
	...
	public void testStoreInInboxMoreThanMemorySizeWithJM() throws Exception {
		...
		mailboxService.storeInInboxWithJM(bs, heavyInputStream, heavyInputStream.available(), true);
	...
	private static class RandomGeneratedInputStream extends InputStream {

...
public class SequenceSet {
    ...
    private final static SequenceSet largest;
    
	static {
		all = new SequenceSet();
		all.addAll();
		
		largest = new SequenceSet();
		largest.set.add(SequenceEntry.STAR);
	}
    ...
    /**
     * The static set that stands for the message with the largest index in the mailbox.
     * 
     * @return the sequenceset that represents the message with the largest index
     */
    public static SequenceSet getLargest() {        
        return largest;
    }
